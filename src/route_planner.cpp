...
RouteModel::Node *RoutePlanner::NextNode() {
    std::cout << "Start NextNode" << "\n";
    RouteModel::Node *result;

    std::sort(open_list.begin(), open_list.end(), Compare);
    std::cout << "After sort" << "\n";
    std::cout << "open_list is empty? " << open_list.empty() << "\n";
    result = open_list.back();
    std::cout << "After .back()" << "\n";
    open_list.pop_back();
    std::cout << "End NextNode" << "\n";
    return result;
}
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    std::cout << "Start ConstructFinalPath" << "\n";
    ...
    std::cout << "End ConstructFinalPath" << "\n";
    return path_found;
}
